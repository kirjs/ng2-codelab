...
describe('Blabla', () => {
  ...
  it(`videos.html: Add click handler to the button, call 'search' method and pass input value `, () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
  ...
  it(`videos.html: Add a message saying 'No videos' which is displayed only when the videos array is empty`, () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
