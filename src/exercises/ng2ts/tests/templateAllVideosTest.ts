...
describe('Blabla', () => {
  ...
  it(polyglot.t(`app.html: Iterate over the videos using '*NgFor', and display a title for each`), () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.componentInstance.search('itten');
  ...
  it(polyglot.t(`app.html: Also display a thumbnail`), () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
    fixture.componentInstance.search('itten');
    fixture.detectChanges();
  ...
  // it(polyglot.t(`#Bonus app.html: Make hitting enter work in the input trigger the search`), () => {
  //   //TODO
  // });

  it(polyglot.t(`#Bonus AppComponent.ts: When the component is created, trigger a search for an empty string. `), () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
    const images = fixture.nativeElement.querySelectorAll('img');
