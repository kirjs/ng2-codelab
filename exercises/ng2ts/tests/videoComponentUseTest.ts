...
describe('Component tree', () => {
  it(polyglot.t(`AppModule: Add the VideoComponent to the AppModule 'declarations'.`), () => {
    let metadata;
    try {
  ...
  it(polyglot.t(`app.html: Use video component (get rid of the old title/thumbnail)`), () => {
  ...
  it(polyglot.t(`app.html: Use the data binding to pass the video object to the component (don't forget the square brackets)`), () => {
    let fixture = TestBed.createComponent(AppComponent);
