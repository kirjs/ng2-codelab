...
describe('Blabla', () => {
  it(polyglot.t(`AppComponent.ts: Add a 'videos' property, set the value as empty array.`), () => {
  ...
  it(polyglot.t(`AppComponent.ts: Add a 'search' method on the component, that takes a 'searchString' parameter.`), () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
  ...
  it(polyglot.t(`app.html: Add a message saying 'No videos' which is displayed only when the videos array is empty`), () => {
    let fixture = TestBed.createComponent(AppComponent);
    fixture.detectChanges();
